...
Additionally, remember to install React, [Material UI](https://mui.com/material-ui/getting-started/installation/), and React Router Dom (using the commands below):
